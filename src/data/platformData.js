export const COURSES_DATA = [
  ...
  {
    id: "ebook-ia-negocios",
    title: "E-book: Sistemas & Vídeos Virais com IA",
    description: "Guia prático para criar produtos digitais, sites, automações, prompts e conteúdos que vendem usando Inteligência Artificial.",
    price: 49.90,
    originalPrice: 99.00,
    paymentLink: "https://mpago.la/2aRktmV",
    duration: "E-book Completo",
    lessonsCount: "120 Páginas",
    instructor: "Equipe NSNexus",
    type: "ebook",
    category: "ia",
    badgeClass: "badge-ia",
    badgeLabel: "E-book",
    ...
    rating: 4.95,
    reviewsCount: 64,
    banner: "images/ebook-ia.png",
    syllabus: [
      {
        moduleTitle: "Acesso ao Livro Digital",
        lessons: [
          { 
            id: "eb-livro-completo", 
            title: "Sistemas & Vídeos Virais com IA (Livro Completo)", 
            duration: "120 pág", 
            type: "pdf",
            fileUrl: "/ebook.pdf"
          }
  ...
  {
    id: "audiobook-ia-negocios",
    title: "Audiobook: IA & Automação para Empresas",
    description: "A versão narrada por IA premium do nosso guia definitivo. Ouça de onde estiver e aprenda a automatizar sua empresa enquanto faz outras tarefas diárias.",
    price: 39.00,
    originalPrice: 79.00,
    paymentLink: "https://mpago.la/2ohH6w9",
    duration: "3h 45min",
    lessonsCount: "5 Capítulos",
    instructor: "Voz IA Premium",
    type: "audiobook",
    category: "ia",
    badgeClass: "badge-systems",
    badgeLabel: "Audiobook",
    level: "Todos os Níveis",
    rating: 4.85,
    reviewsCount: 42,
    banner: "images/audiobook-ia.png",
    syllabus: [
      {
        moduleTitle: "Áudio Completo por Capítulos",
        lessons: [
          { id: "ab-ch1", title: "Capítulo 1: Introdução ao Mercado de IA para Empresas", duration: "25 min", type: "audio", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3" },
          { id: "ab-ch2", title: "Capítulo 2: Engenharia de Prompts na Prática", duration: "32 min", type: "audio", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3" },
          { id: "ab-ch3", title: "Capítulo 3: Ferramentas Essenciais de Produtividade", duration: "28 min", type: "audio", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3" },
          { id: "ab-ch4", title: "Capítulo 4: Automatizando Atendimento com WhatsApp", duration: "42 min", type: "audio", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3" },
          { id: "ab-ch5", title: "Capítulo 5: Casos de Sucesso e Próximos Passos de Automação", duration: "35 min", type: "audio", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-5.mp3" }
        ]
      }
    ]
  }
